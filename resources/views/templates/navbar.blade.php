    ...
    <div class="horizontal-mainwrapper container clearfix">
        <nav class="horizontalMenu clearfix">
            <ul class="horizontalMenu-list">
                ...
                <li aria-haspopup="true">
                    <a href="{{ route('albums.index')}}" class="sub-icon">
                ...
                <li aria-haspopup="true">
                    <a href="{{ route('galeries.index')}}" class="sub-icon">
                ...
                <li aria-haspopup="true">
                    <a href="{{ route('authors.index')}}" class="sub-icon">
                ...
                <li aria-haspopup="true">
                    <a href="{{ route('articles.index')}}" class="sub-icon ">
