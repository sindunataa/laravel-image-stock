                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col mb-4 mt-4">
                                <a href="{{ route('articles.create')}}" class="btn btn-primary"><i class="fe fe-plus"></i> Add News</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="{{ asset('uploads/'.$article->image) }}" alt=""> </td>
                                            <td class="text-right">
                                                <form action="{{ route('articles.destroy',$article->id) }}" method="POST">
                                    
                                                    <a class="btn btn-sm btn-success" href="{{ route('articles.edit',$article->id) }}">Edit</a>
